...
<html lang="en">
  ...
  <body>
    ...
    <div class = 'text-center mt-5'>
        <form style = 'max-width:400px; margin:auto;' action="scripts\login.php" method='post'>
            ...
            <input class = "form-control" type="text" name='uname' placeholder='Till Name' required autofocus>
